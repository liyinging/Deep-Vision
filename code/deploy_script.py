...
def main():
    ...
    ssh = ssh_client()
    ssh_connection(ssh, "ec2-54-200-234-19.us-west-2.compute.amazonaws.com", "ec2-user", "/classes/licenses/Liying_1604.pem")
    git_clone_pull(ssh, "liyinging", "Deep-Vision")
    create_or_update_environment(ssh, "Deep-Vision")
    # set_crontab(ssh)
